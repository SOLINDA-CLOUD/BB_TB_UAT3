...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _default_partner(self):
        return self.env['res.partner'].search([('name', '=', 'PT. TABOO TRADING INDONESIA')], limit=1).id
    ...
    def _prepare_purchase_order_line(self, po, item):
        ...
        vals = {
            ...
            'fabric_por': item.line_id.fabric_smp.id,
            'lining_por': item.line_id.lining_smp.id,
